...
* install system
  sudo apt-get install git vim-gtk3 global cscope ibus ibus-pinyin net-tools volumeicon-alsa feh meld dmenu openbox tint2 cmake gcc g++ make flex bison gperf genromfs \
